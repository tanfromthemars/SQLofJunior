...
namespace HotelManager
{
    public partial class fUseService : Form
    {
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            {
                if (item != button)
                    DrawControl((item as Bunifu.Framework.UI.BunifuTileButton).Tag as RoomDTO, item as Bunifu.Framework.UI.BunifuTileButton);
            }

            RoomDTO room = button.Tag as RoomDTO;
            ShowBill(room.Id);
        ...
        {
            List<RoomTypeDTO> roomTypes = RoomTypeDAO.Instance.LoadListRoomType();
        ...
        private void LoadListServiceType()
        {
        ...
        public void DrawControl(RoomDTO room, Bunifu.Framework.UI.BunifuTileButton button)
        {
        ...
        {
            LoadListService((cbServiceType.SelectedItem as ServiceTypeDTO).Id);
        }
        ...
        private void cbService_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cbService.SelectedItem != null)
                txbPrice.Text = (cbService.SelectedItem as ServiceDTO).Price.ToString("c0", cultureInfo);
        }

        private void btnAdd_Click(object sender, EventArgs e)
        {
            totalPrice = 0;
            RoomDTO room = flowLayoutRooms.Tag as RoomDTO;
            AddBill(room.Id, (cbService.SelectedItem as ServiceDTO).Id, int.Parse(numericUpDownCount.Value.ToString()));
            ShowBill(room.Id);
