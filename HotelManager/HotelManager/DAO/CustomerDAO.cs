...
namespace HotelManager.DAO
{
    public class CustomerDAO
    {
        ...
        public CustomerDTO GetInfoByIdCard(string idCard)
        {
            string query = "USP_IsIdCardExists @idCard";
            CustomerDTO customer = new CustomerDTO(DataProvider.Instance.ExecuteQuery(query, new object[] { idCard }).Rows[0]);
            return customer;
        }
        ...
        internal bool InsertCustomer(CustomerDTO customer)
        {
        ...
        internal bool UpdateCustomer(CustomerDTO customerNow, CustomerDTO customerPre)
        {
            ...
            customerNow.Sex, customerNow.Nationality, customerNow.IdCard };
