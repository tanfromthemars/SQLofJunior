...
namespace HotelManager.DAO
{
    ...
    public class ExportToExcel
    {
        ...
        {
            bookExcel.ExportAsFixedFormat(Excel.XlFixedFormatType.xlTypePDF, path,
        ...
        private void ToExcel(Excel.Workbook bookExcel, string path, Excel.XlFileFormat fileFormat)
        {
            ...
            try
            {
                bookExcel.SaveAs(path, fileFormat, misValue, misValue, false, false, Excel.XlSaveAsAccessMode.xlExclusive,
                    Excel.XlSaveConflictResolution.xlLocalSessionChanges, misValue, misValue, misValue, misValue);
            }
            catch
            {
